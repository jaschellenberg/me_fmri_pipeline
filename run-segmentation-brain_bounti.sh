...
test_file=reconstructions/recon_struct_brain_e02_dyn0.nii.gz
...
module load mirtk
mirtk prepare-for-monai res-global-files/ stack-global-files stack-global-info.json stack-global-info.csv ${res} ${Num_stacks} ${test_file}
...
mirtk prepare-for-monai res-masked-files/ stack-masked-stack-files/ masked-label-info.json masked-label-info.csv ${res} ${Num_stacks} cropped-input-files/*nii*
module unload mirtk
...
module load mirtk
mirtk transform-image monai-segmentation-results/*gz reconstructions/recon_struct_brain_labels.nii.gz -target ${test_file} -labels 
module unload mirtk
